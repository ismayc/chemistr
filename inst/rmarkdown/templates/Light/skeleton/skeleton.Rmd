...
## Q1: What colors are found in a white light source?  Are all white light sources the same?
...
include_graphics("name of figure in directory") #Make sure file is in your folder
```
