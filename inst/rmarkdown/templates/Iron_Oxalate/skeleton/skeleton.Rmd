...
MassPer_K <- c(" ", "22.7%") #Mass % K in Green Crystals
K <- data_frame(Sample, Mass, EOB, T_Analysis, Raw_Counts, Counts_o, Mass_K, MassPer_K) #Here are the items you want to include in Table 1
...
MassPer_Fe <- c() #The mass percent of iron in the green crystals
Fe <- data_frame(Mass, Slope, Fe_dilute, Mass_Fe, MassPer_Fe) #Here are the items you want to include in Table 2
...
MassPer_Ox <- c() #The mass percent of oxalate in the green crystals
Oxalate <- data_frame(Mass, Titrant, Volume, Mass_Oxalate, MassPer_Ox) #Here are the items you want to include in Table 3
...
MassPer_water <- c() #The mass percent water in the green crystals
Water <- data_frame(Mass, Mass_final, Mass_water, MassPer_water) #Here are the items you want to include in Table 3
...
RSD <-       #Calculate the Relative Standard Deviation.  See Stats help sheet on Moodle if you need help.
...
n <-  #The lowest number of trials included in the mass percent averages.  For example if you has 7 trials for Fe and 11 for all the others, then n = 7. 
EX_95CI <- qt(0.975,df=n-2)*EX_SD/(sqrt(n))
