---
title: 'Experiment 10: Protein Stability'
author: "Insert Names"
...
```{r, echo=TRUE, fig.cap = "Input Caption", results = 'asis'}
...
Fraction_Folded_1 <-   #Calculate the fraction of protein folded = (Absorbance of Sample in Guanadinium)/(Absorbance of Sample in Buffer) Use the absorbance in only phosphate buffer as 100% folded.  Watch sig figs.
d_Suniverse_1 <-  #Calculate dSuniverse based upon Equation 3 in the instructions
T_1 <- data.frame(GdnCl_Concentration, Absorbance_1, Fraction_Folded_1, d_Suniverse_1)
...
newdata <- subset(T_3, GdnCl_Concentration >= 0.1 & GdnCl_Concentration <= 5, select=c(GdnCl_Concentration, d_Suniverse_1))  #This code will allow you to only select a subset of your values in Table 2.  This is important in making sure you are significantly above 0% and below 100% folded.
chem_scatter(newdata, GdnCl_Concentration, d_Suniverse_1, xlab = "Insert Label", ylab= "Insert Label")
fit1 <- lm(d_Suniverse_1 ~ Gdn_Concentration, data = newdata) #remember to view the values from this, you must type summary(fit1) into the console.
summary(fit1)
...
```{r, echo=FALSE, fig.cap = "Input Caption", results = 'asis'}
...
Fraction_Folded_2 <-      
d_Suniverse_2 <- -
T_2 <- data.frame(GdnCl_Concentration, Absorbance_2, Fraction_Folded_2, d_Suniverse_2)
...
Fraction_Folded_3 <-      
d_Suniverse_3 <- -
T_3 <- data.frame(GdnCl_Concentration, Absorbance_3, Fraction_Folded_3, d_Suniverse_3)
...
Fraction_Folded_4 <-      
d_Suniverse_4 <- -
T_4 <- data.frame(GdnCl_Concentration, Absorbance_4, Fraction_Folded_4, d_Suniverse_4)
...
#Use equation 2 in the instructions to create a graph that will determine the entropy and enthalpy of folding.  Make sure to include the protein you are studying, the slope (+/- uncertainty) and the intercept (+/- uncertainty) in the caption.
