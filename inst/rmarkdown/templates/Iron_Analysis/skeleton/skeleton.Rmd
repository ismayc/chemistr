...
# Here is where you create your standard curve. 
...
#This is a GOOD picture of your calculation from Abs to mg Fe/Tablet.  Include every calc and every unit.
...
#R Calculations for Average Iron, Standard Deviation, 95% Confidence Interval.  Use the Stats help sheet on Moodle for inputting this code.  Finish with creating a chem_table of your stats results (with the correct sig figs)
