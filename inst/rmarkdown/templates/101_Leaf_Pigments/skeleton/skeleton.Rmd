...
Pigment <- c("Anthocyanin", "Chlorophyll B", "Chlorophyll A", "Xanthophyll", "Carotenoid")
Spec_Literature<- c() #This is the lambda max from the UV/VIS spectrum of the control pigments found in the appendix of the Leaf lab instructions. If there are multiple lambda max values, you can use quotes such as c("252, 298", "520").  This shows the first pigment has two lambda max values at 252 and 298 nm while the second pigment only has a lammbda max at 520 nm.
