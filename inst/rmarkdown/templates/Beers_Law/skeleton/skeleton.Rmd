...
```{r plot3, echo=FALSE, fig.cap=knitr:::escape_latex("Insert Caption")}
...
```{r plot4, echo=FALSE, fig.cap=knitr:::escape_latex("Insert Caption")}
chem_scatter(data = dye_data, xvar = dye, yvar = Transmittance, intercept = 1)
```

```{r fit4coef}
fit4 <- lm(I(Transmittance - 1) ~ dye + 0, data = dye_data)
coefficients(fit4)
```
