...
Transmittance_Student1 <- #We want the transmittance only due to the bue food coloring and not any interaction of the water.  So to get the final transmittance values subtract the Transmittance_Water variable from the Transmitance_Blue variable. Also change the Transittance variable name to include your intitials.  For example Transmittance_DC.
